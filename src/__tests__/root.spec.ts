...
test('insert a bunch with delete', async t => {
  ...
  console.log(`originSN: ${originSet.size}, removeSN: ${removeSet.size}; expected: ${originSet.size - removeSet.size}, actual len(n2a): ${n2a.size}`)
  assertSize(t, n2a, BigInt(originSet.size - removeSet.size))
